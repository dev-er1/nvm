// nvm-core/benches/executors/jumptable/dense_arithmetic_10k.rs
//
// Программа: линейный код без переходов — 10 000 инструкций
// `IADD`. Зеркальный файл — `match_vm::dense_arithmetic_10k`.
...
pub fn dense_arithmetic_10k(c: &mut Criterion) {
    ...
    c.bench_function("jumptable/dense_arithmetic_10k", |b| {
