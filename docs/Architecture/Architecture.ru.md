...
### Выполнение байткода
После загрузки байткода и выделения памяти происходит выполнение программы. NVM выполняет байткод.
...
- ВМ:
    ...
    - Исполнитель: [`vm/executer.rs`](../../nvm-core/src/vm/executer.rs)
